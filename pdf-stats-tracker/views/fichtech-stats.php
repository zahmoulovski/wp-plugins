<div class="wrap">
    <h1><?php _e('PDF Stats Tracker - Fichtech Stats', 'pdf-stats-tracker'); ?></h1>
    
    <p>
        <?php _e('Statistics for PDF files in the <strong>fichtech</strong> folder:', 'pdf-stats-tracker'); ?>
        <code>https://klarrion.com/fichtech/</code>
    </p>
    ...
    <div class="pdf-stats-table-container">
        <?php if (empty($fichtech_stats)) : ?>
            <p><?php _e('No data available yet for fichtech PDFs.', 'pdf-stats-tracker'); ?></p>
        <?php else : ?>
            <table class="widefat striped pdf-stats-table">
                ...
                <tbody>
                    <?php foreach ($fichtech_stats as $pdf) : ?>
                        <tr>
                            <td>
                                <?php 
    ...
    <div class="pdf-stats-export">
        ...
        <form method="post" action="">
            ...
            <input type="hidden" name="export_folder" value="fichtech">
